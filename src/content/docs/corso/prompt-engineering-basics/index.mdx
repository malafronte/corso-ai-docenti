...
import lessonAudio from "@assets/audio-lessons/Prompt_Engineering_Basics_-_Prompt_Engineering_per_Docenti__L_Arte_di_Dialogare_con_l_IA_pe.m4a";
import VideoPlayer from "@components/VideoPlayer.astro";
import lessonVideo from "@assets/video-lessons/Prompt_Engineering_Basics_-_L_Arte_del_Prompt_Perfetto.mp4";

## Ascolta la lezione

<AudioPlayer src={lessonAudio} filename="Lezione: Principi di Prompt Engineering per la Didattica" />

## Guarda la lezione
<VideoPlayer
  src={lessonVideo}
  filename="Video: L'Arte del Prompt Perfetto"
/>
