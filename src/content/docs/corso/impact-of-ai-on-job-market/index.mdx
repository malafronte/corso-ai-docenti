...
import lessonAudio from "@assets/audio-lessons/Impact_of_AI_On_Job_Market_-_IA_e_Lavoro__Aumento,_Trasformazione_e_Ricollocazione_–_Cosa_Ri.m4a";
import VideoPlayer from "@components/VideoPlayer.astro";
import lessonVideo from "@assets/video-lessons/Impact_Of_AI_On_Job_Market_-_L_IA_e_il_Lavoro.mp4";

## Ascolta la lezione

<AudioPlayer src={lessonAudio} filename="Lezione: L'impatto dell'AI nel mercato del lavoro" />

## Guarda la lezione
<VideoPlayer
  src={lessonVideo}
  filename="Video: L'IA e il Lavoro"
/>
...
![Immagine di un cervello umano connesso a una rete neurale digitale](cervello-connesso-a-rete-neurale-50.png)
