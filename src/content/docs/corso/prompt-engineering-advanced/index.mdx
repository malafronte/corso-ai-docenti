...
import lessonAudio from "@assets/audio-lessons/Prompt_Engineering_Advanced_-_Oltre_il_Riassunto__LLM,_Tecniche_Avanzate_e_l_IA_come_Architet.m4a";
import VideoPlayer from "@components/VideoPlayer.astro";
import lessonVideo from "@assets/video-lessons/Prompt_Engineering_Advanced_-_IA__Da_Assistente_a_Partner.mp4";

## Ascolta la lezione

<AudioPlayer src={lessonAudio} filename="Lezione: Prompt Avanzati e Progettazione Didattica" />

## Guarda la lezione
<VideoPlayer
  src={lessonVideo}
  filename="Video: IA - Da Assistente a Partner"
/>
