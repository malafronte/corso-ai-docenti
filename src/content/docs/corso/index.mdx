...
import lessonAudio from "@assets/audio-lessons/Corso_-_AI_e_Didattica__La_Rivoluzione_Consapevole_del_Docente_tra_Prom.m4a";
import VideoPlayer from "@components/VideoPlayer.astro";
import lessonVideo from "@assets/video-lessons/Corso_-_L_IA_in_Classe__Una_Guida_per_Insegnanti.mp4";

## Ascolta la lezione

<AudioPlayer src={lessonAudio} filename="Presentazione del corso" />

## Guarda la lezione
<VideoPlayer
  src={lessonVideo}
  filename="Video: L'IA in Classe"
/>
