...
import lessonAudio from "@assets/audio-lessons/Creativity_And_Inclusion_-_IA_Creativa_e_BES__La_Rivoluzione_Visiva_per_l_Inclusione_Scola.m4a";
import VideoPlayer from "@components/VideoPlayer.astro";
import lessonVideo from "@assets/video-lessons/Creativity_And_Inclusion_-_IA__Creatività_e_Inclusione.mp4";

## Ascolta la lezione

<AudioPlayer src={lessonAudio} filename="Lezione: IA per la Creatività e l'Inclusione" />

## Guarda la lezione
<VideoPlayer
  src={lessonVideo}
  filename="Video: IA per la Creatività e l'Inclusione"
/>
...
- **Istruzioni Dettagliate:**
    ...
    4. A partire dalle fonti caricate si può chiedere a NotebookLM di caricare altre fonti attinenti da ricercare nel web dando il seguente criterio di ricerca: *"confronta il pensiero di Karl Popper con quello del Circolo di Vienna. Includi nodi per i concetti chiave come 'principio di verificazione', 'principio di falsificazione', 'criterio di demarcazione', 'ruolo dell'induzione', e 'metafisica'. Mostra le connessioni e le opposizioni tra le due correnti di pensiero"*
...
- **Istruzioni e Prompt:**
    1. All'interno di NotebookLM, creare un nuovo notebook e caricare i seguenti documenti come fonti:
        ...
        **In questo esempio si considera il NotebookLM descritto in precedenza nell'articolo [Vita, Potere e Società nel Basso Medioevo (Storia - classe terza - Liceo delle Scienze Umane)](../../lesson-examples/basso-medioevo)**.
