...
**Nel caso in cui il codice in Markdown contenesse elementi che desiderati nella mappa concettuale, come ad esempio le citazioni, è possibile chiedere all'LLM di eliminare le parti da rimuovere**. **Tuttavia non sempre tutti i chatbot riescono a comprendere le richieste**. Ad esempio, in Gemini la richiesta seguente non ha prodotto il risultato atteso:
