...
import lessonAudio from "@assets/audio-lessons/Personalized_Learning_Experiences_-_Dall_Oceano_del_Web_alla_Tua_Conoscenza__IA_Ancorata_alle_Fonti.m4a";
import VideoPlayer from "@components/VideoPlayer.astro";
import lessonVideo from "@assets/video-lessons/Personalized_Learning_Esperiences_-_Da_Utente_a_Architetto_dell_IA.mp4";

## Ascolta la lezione

<AudioPlayer src={lessonAudio} filename="Lezione: Esperienze didattiche personalizzate con NotebookLM, Perplexity, Chatbot RAG e strumenti per l'inclusione" />

## Guarda la lezione
<VideoPlayer
  src={lessonVideo}
  filename="Video: IA - Da Utente a Architetto dell'IA"
/>
